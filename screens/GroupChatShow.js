...
export default class GroupChatShow extends React.Component {
  constructor(props) {
    ...
    var grp_details =
      this.state.gp_name + this.state.createdTime + " " + this.state.createdDay;
    console.log(grp_details);
  }
  componentWillMount() {
    firebase
      .database()
      ...
      >
            ...
            <Button
              onPress={() =>
                this.props.navigation.navigate("GroupDetails", {
                  ...
                  createDay: this.state.createdDay,
                })
              }
            >
              {this.state.gp_name}
        ...
        >
          ...
          <TouchableOpacity
            ...
            style={{ paddingBottom: 10, marginLeft: 5, marginTop: 10 }}
          >
